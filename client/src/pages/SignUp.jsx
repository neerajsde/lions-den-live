            ...
            <div className='w-[500px] flex flex-col text-white bg-[#111] py-6 px-8 max-sm:p-4 rounded-xl gap-2 max-sm:gap-4 max-md:w-[400px] max-sm:w-full'>
                ...
                <div className='w-full flex flex-col gap-4 max-md:gap-3'>
                    ...
                    <div className='w-full flex justify-start'>
                        <button className='text-lg max-md:text-base flex items-center gap-4 font-extrabold text-white border-2 border-yellow-500 bg-yellow-500 py-1 px-4 rounded-3xl transition duration-300 ease-in hover:bg-transparent' onClick={signupHandler}>
                            {isLoading && <SmSpinner />}Sign Up
                        </button>
                    </div>
                </div>
                ...
                <div className='w-full flex items-center justify-start gap-2'>
                    ...
                    <p className='text-md max-md:text-sm font-semibold text-yellow-500 cursor-pointer transition duration-200 ease-in hover:underline' onClick={() => navigate('/admin-login')}>Admin Log in</p>
                </div>
            </div>
        </div>
    );
